      ...
      <div className="w-full max-w-[440px] animate-in fade-in zoom-in-95 duration-700 fill-both relative z-10">
        ...
        <div className="bg-white/80 backdrop-blur-xl border border-zinc-200/60 p-8 sm:p-10 rounded-[2rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.08)]">
          <Tabs defaultValue="signin" className="w-full">
            <TabsList className="grid w-full grid-cols-2 mb-8 bg-zinc-100 p-1 rounded-2xl">
              <TabsTrigger value="signin" className="rounded-xl data-[state=active]:bg-white data-[state=active]:shadow-sm transition-all font-semibold">
                Ingresar
              </TabsTrigger>
              <TabsTrigger value="signup" className="rounded-xl data-[state=active]:bg-white data-[state=active]:shadow-sm transition-all font-semibold">
                Registrarse
              </TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="signin" className="mt-0 outline-none">
              <div className="mb-6 text-center space-y-2">
                <h1 className="text-2xl font-bold text-zinc-900 tracking-tight">Acceso al Sistema</h1>
                <p className="text-zinc-500 text-sm font-medium">Ingresa tus credenciales para continuar</p>
              </div>
            ...
            <TabsContent value="signup" className="mt-0 outline-none">
              ...
              <form onSubmit={handleSignUp} className="space-y-4">
                ...
                <Button type="submit" disabled={loading} className="w-full h-12 mt-2 bg-emerald-600 hover:bg-emerald-700 rounded-xl text-md font-bold shadow-lg shadow-emerald-600/20">
